...
// piid 1 (stream_status) and piid 10 (camera_light) are device-reported and
// exposed as readable states — both the dreamehome adapter and the Home
// Assistant dreame integration expose piid 10 as the camera light.
// stream_status's payload is a streaming-session object, not a number — observed on
